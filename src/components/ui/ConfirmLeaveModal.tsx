  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div
        ...
        className="bg-surface-base dark:bg-surface-base-dark rounded-xl shadow-xl p-6 w-full max-w-sm mx-4"
      >
        <h2 id="confirm-leave-title" className="text-base font-semibold text-fg-base dark:text-fg-base-dark mb-2">Unsaved changes</h2>
