...
const COMPONENT_TOKENS: Record<ComponentType, (keyof TokenColors)[]> = {
  ...
  avatar:     ['brandSub', 'brandText', 'successSub', 'successText', 'warningSub', 'warningText', 'dangerSub', 'dangerText', 'success', 'border'],
  progress:   ['brand', 'brandSub', 'success', 'successSub', 'warning', 'warningSub', 'danger', 'dangerSub'],
  tooltip:    ['neutralStrong', 'textPri', 'brand', 'warning'],
